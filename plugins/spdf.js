...
let toxicdevil = Config.WORKTYPE == 'public' ? false : true
   ...
   Kelly.addCommand({pattern: 'spdf ?(.*)', fromMe: toxicdevil, desc: 'Converts Site to PDF.' }, (async (message, match) => {
    ...
    await message.sendMessage(Buffer.from(webimage.data), MessageType.document, {mimetype: Mimetype.pdf, filename: 'Kelly-Mwol.pdf'});
