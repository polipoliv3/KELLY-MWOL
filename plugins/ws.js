...
if (Config.WORKTYPE == 'private') {
    ...
    Kelly.addCommand({pattern: 'ws', fromMe: true, desc: Lang.WS}, (async (message, match) => {
...
// EXPORTING
        ...
        await message.client.sendMessage(message.jid, Buffer(respovideo.data), MessageType.video, {mimetype: Mimetype.mp4, quoted: message.data, caption: '◄━━━━━━━⦁⦁ *ᴍᴀᴅᴇ ʙʏ ᴋᴇʟʟʏ* ⦁⦁━━━━━━━━►'})
    ...
    Kelly.addCommand({pattern: 'ws', fromMe: false, desc: Lang.WS}, (async (message, match) => {
...
// EXPORTING
        reply = await message.client.sendMessage(message.jid,'*꧁•⊹٭𝚄𝙿𝙻𝙾𝙰𝙳𝙸𝙽𝙶 𝚆𝙷𝙰𝚃𝚂𝙰𝙿𝙿 𝚂𝚃𝙰𝚃𝚄𝚂٭⊹•꧂*',MessageType.text);
        await message.client.sendMessage(message.jid, Buffer(respovideo.data), MessageType.video, {mimetype: Mimetype.mp4, caption: '◄━━━━━━━⦁⦁ *ᴍᴀᴅᴇ ʙʏ ᴋᴇʟʟʏ* ⦁⦁━━━━━━━━►',})
