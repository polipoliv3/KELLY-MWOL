...
if (Config.WORKTYPE == 'private') {
    ...
    Kelly.addCommand({pattern: 'xxxtentacion', fromMe: true, desc: 'random xxxtentacion images'}, (async (message, match) => {
...
var i = Math.floor(15*Math.random())
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '𝐌𝐀𝐃𝐄 𝐁𝐘 𝐊𝐄𝐋𝐋𝐘 '})
    ...
    Kelly.addCommand({pattern: 'xxxtentacion', fromMe: false, desc:'random xxxtentacion images '}, (async (message, match) => {
