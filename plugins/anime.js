...
if (Config.WORKTYPE == 'private') {
    ...
    Kelly.addCommand({pattern: 'anime', fromMe: true, desc: 'random anime image'}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '𝐌𝐀𝐃𝐄 𝐁𝐘 𝐊𝐄𝐋𝐋𝐘 𝐌𝐖𝐎𝐋'})

    }));
}
else if (Config.WORKTYPE == 'public') {

    Kelly.addCommand({pattern: 'anime', fromMe: false, desc:'random anime image '}, (async (message, match) => {
